...
public class CheeseTopping extends HamburgerIngredient{
    public CheeseTopping(Hamburger hamburger) {
        this.hamburger = hamburger;
        ImageIcon bottomIcon = new ImageIcon("C:\\Users\\rogiw\\Desktop\\HW4-image\\Cheese.png");
    ...
    public String getDescription() {
        return this.hamburger.getDescription() + " CheeseTopping";
    }
}
